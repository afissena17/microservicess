...
public class Transaksi {
    ...
    @Column(nullable = false)
    private Integer meterBulsenalu;
    ...
    public Transaksi(String pelanggan, Integer meterBulanIni, Integer meterBulsenalu, BigDecimal tarifPerMeter) {
        this.pelanggan = pelanggan;
        this.meterBulanIni = meterBulanIni;
        this.meterBulsenalu = meterBulsenalu;
    ...
    public void hitungPemakaianDanTotal() {
        this.pemakaian = this.meterBulanIni - this.meterBulsenalu;
    ...
    public Integer getMeterBulsenalu() {
        return meterBulsenalu;
    }
    
    public void setMeterBulsenalu(Integer meterBulsenalu) {
        this.meterBulsenalu = meterBulsenalu;
    }
